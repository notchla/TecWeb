...
const formsList = {
  ...
  description: {
    form:
      '<label for="question" class="col-form-label"> Enter description </label> ' +
  ...
  open_question: {
    form:
      '<label for="question" class="col-form-label"> Enter question </label> ' +
      '<input class="form-control" id="question"></input>' +
      '<label for="answer" class="col-form-label"> Enter answers (comma separed list) </label> ' +
  ...
  closed_question: {
    form:
      '<label for="question" class="col-form-label"> Enter question </label> ' +
      '<input class="form-control" id="question"></input>' +
      '<label for="answer" class="col-form-label"> Enter possible answers (comma separed list) </label> ' +
      '<textarea class="form-control" id="answer"></textarea>',
    outputs: 0,
    min_outputs: 0,
  },
  minigame: {
    form:
      ...
      "</select>" +
      '<label for="question" class="col-form-label"> Minimum score </label> ' +
