...
const formsList = {
  ...
  description: {
    form: '<label for="message-text" class="col-form-label"> Enter description </label> ' +
    '<input class="form-control" id="question"></input>',
    outputs: 1,
    min_outputs : 0
  },
  open_question: {
    form: '<label for="message-text" class="col-form-label"> Enter question </label> ' +
    '<input class="form-control" id="question"></input>' +
  ...
  minigame: {
    form: '<select id="select" class="browser-default custom-select">' +
        '<option selected="">Open this select menu</option>' +
        '<option value="clicker">Clicker</option>' +
      '</select>' +
    '<label for="message-text" class="col-form-label"> Minimum score </label> ' +
